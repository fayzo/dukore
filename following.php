...
<html>
	<head>
		<title><?php echo $profileData['screenname'].' @'.$profileData['username'].' Following' ;?></title>
		<meta charset="UTF-8" />
...
<div class="profile-extra-footer">
	...
	<!-- in left end-->
		...
		<div class="wrapper-following">
			<div class="wrap-follow-inner" style="width:800px;margin:auto;">
              <?php $follow->FollowingLists($profileData['user_id'],$user_id);?>
